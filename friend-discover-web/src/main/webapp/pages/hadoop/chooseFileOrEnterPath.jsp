...
<body>
    ...
    <div id="coep_cont" style="padding:40px 50px 30px;">
        <form id="hdfs_file_form" action="hadoop/uploadFile2HDFSRequestUrl" method="post" enctype="multipart/form-data"><!-- 默认action为上传文件到hdfsurl-->
            <table>
                ...
                <tr id="selected_folder_tr" style="display:none;">
                    <td colspan="2" >
                        <div>选中：<span id="path_cnt">0</span>个文件夹，<span id="file_cnt">0</span>个文件：</div>
                        <div id="container" style="height:100px;width:330px;overflow:auto;">
                            <ul id="dir-tree" ></ul>
                        </div>
                    </td>
                </tr>
