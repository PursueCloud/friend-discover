...
import com.yo.friendis.core.hadoop.mapred.filter.mr.FindInitDCMapper;
import com.yo.friendis.core.hadoop.mapred.filter.mr.FindInitReducer;
...
public class FindInitDCJob extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
	    ...
	    long records=job.getCounters().findCounter(FilterCounter.MAP_COUNTER)
	    	    .getValue();
	    CommonUtils.simpleLog("总记录数："+records);
