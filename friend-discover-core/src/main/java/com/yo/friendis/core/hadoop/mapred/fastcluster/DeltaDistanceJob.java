...
import com.yo.friendis.core.hadoop.mapred.fastcluster.mr.DeltaDistanceMapper;
import com.yo.friendis.core.hadoop.mapred.fastcluster.mr.DeltaDistanceReducer;
...
public class DeltaDistanceJob extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		ToolRunner.run(HadoopUtils.getConf(), new DeltaDistanceJob(), args);
	}
